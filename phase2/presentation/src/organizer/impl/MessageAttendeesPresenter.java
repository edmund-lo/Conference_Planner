...
import model.User;
import organizer.IMessageAttendeesPresenter;
import organizer.IMessageAttendeesView;

import java.util.ArrayList;
import java.util.List;

public class MessageAttendeesPresenter implements IMessageAttendeesPresenter {
    private IMessageAttendeesView view;
    private ObservableList<User> users;
    private final PseudoClass errorClass = PseudoClass.getPseudoClass("error");

    public MessageAttendeesPresenter(IMessageAttendeesView view) {
        this.view = view;
        init();
    }
